...
\hspace{-0.8cm}\colorbox{my_light_blue}{\parbox{\linewidth}{%
...
\hspace{-0.8cm}\colorbox{my_yellow}{\parbox{\linewidth}{%
...
\hspace{-0.8cm}\colorbox{my_green}{\parbox{\linewidth}{%
...
\todo[inline]{create 3 sections in the the pseudocode}
\todo[inline]{create 3 images which explain what the motion planning algorithms does in that section of the algoritm}
