...
with $0 \leq i < i_{\textrm{max}} = \frac{x_{\mathit{grid}}}{s_{\mathit{cell}}}, \quad 0 \leq j < j_{\textrm{max}} = \frac{y_{\mathit{grid}}}{s_{\mathit{cell}}}, \quad 0 \leq k < k_{\textrm{max}} = 2\pi$.\bs
