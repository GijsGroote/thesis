...
\todo{for the text below about how large joint space will become Corrado: Cn you mathematically write how big the space of combinations is? This will make your point clear and concise, instead of being just a vague claim }
...
\todo{Corrado: Another analysis ... this is a very informal sentence}
...
\todo{Corrado: Why now and not before for instance? Instead of saying this, you can say that a number of researchers tackled this problems. In the following we provide a categorization and a summary of the methods, advantages and disadvantages of the most relevant sota}
...
\todo{Corrado: what means "mostly". Using this word, you imply that there are some cases in which you cannot treat it as a 2D environment, and you also imply that it is important to know when that is the case.}
