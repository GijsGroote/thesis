...
\todo{It is pretty weird that you introduce constraints set to then alter, not check for contstraints in the path planning algorithm}
...
\todo{Is is clear that the robot is an object?}
...
\end{figure}
\todo{Aks Corrado, does it make sense to include the boxer robot, path planning is completely holonomic, and boxer robot is not used}
