...
\chapter*{Benchmark Tests}%
 ...
 \todo{you could do a little more than just throwing these in here, even if it is the appendix}
...
\todo{re-read, re-write, re-structure what is below, but only if Corrado thinks it adds at least some value to the thesis}
...
\todo{
todore-read, re-write, re-structure what is below, but only if Corrado thinks it adds at least some value to the thesis
}
