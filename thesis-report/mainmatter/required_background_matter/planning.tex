...
\todo{So how are the non-holonomic constraints checked? Eleborate en become clear about that? f}
...
The point robot has a cylindrical shape; thus, a two dimensional configuration space can represent the free and obstacle space which can be seen in \Cref{fig:two_pushes_to_freedom_conf_space}.
