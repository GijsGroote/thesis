...
\todo{Corrado: Since here you make the case of predictive control, make it clear that there are other methods but you chose predictive once because you need a time horizon for your tasks. Then, among the predicti controllers you explain two variants, the MPC and the mppi }
