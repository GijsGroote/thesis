...
\begin{algorithm}[H]
  \caption{Pseudocode for modified \ac{RRTstar} path planning algorithm. Lines that contain changes compared to \Cref{pseudocode:proposed_rrt_star_all} are indicated with the red colour.}%
