...
An action edge, contains a drive or push action. 
\todo{Corrado: same thing belwo, thisi  Vague. Rephrase at the level of a msc document. Consider, from a, clear, precise }
...
INITIALIZED (IN): & The edge is created with a source and target node which are present in the \ac{hgraph}. \todo{Corrado: how then?} A choice of controller is made. \\
